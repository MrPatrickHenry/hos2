...
<meta name="keywords" content="Tops Shoes Skirts Jackets High Street Sale">
...
curl_setopt($curl, CURLOPT_RETURNTRANSFER, 1);
	...
	".$request_url."
	 \" addthis:title=\"     \" 
				...
				<a class=\"link\" onClick=\"ga('send', 'event', 'interest', 'clickbuy', 'clickbuysite', 5);\"  href =\"{$item -> linkurl}&amp;u1=site\"/>Buy</a>
                   </div>
				   </div>
                   ";
     ...
     No Items Available</h2>
      ...
      <a class="scrollup" href="#up">
           <i class="fa fa-angle-up" style="font-size:36px;font-family: 'EB Garamond', serif;"></i></a>
