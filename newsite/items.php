...
<body>
    ...
    <nav>
        <ul class="list-unstyled main-menu">
          ...
          <!--Include your navigation here-->
          <li class="text-right"><a href="index.php" id="nav-close"><i class="fa fa-times" style="color:#98C93C"></i>
...
We do all the hunting and bring them to you. </p>
  ...
  $request_url = apache_getenv("HTTP_HOST") . apache_getenv("REQUEST_URI");
            ...
            # CURL SETTINGS.
            curl_setopt($curl, CURLOPT_URL, "http://productsearch.linksynergy.com/productsearch?token=4acca9e0828906b9c844db7474c1db8ce6c652a873a8c625550cb57000808f5c&keyword=%22dresses%22&cat=%22%22&MaxResults=100&pagenumber=9&mid=36420&sort=productname&sorttype=asc");
