...
font-family: 'Ledger', serif;	color: rgb(152, 201, 60);
   ...
   .link{
    ...
    font-size: 13px;
padding: 10px 62px;	text-decoration:none;
	margin-top:5px;
...
<title>House of sale, collects  the Dresses,Tops,Shoes,Skirts,Jackets,Trousers from
Warehouse, Dorothy Perkins, Monsoon, Miss Selfridges</title></head>
<body>
<div id="header"> 
  <h1>
    <script>
...
<div id="container">
  ...
  $request_url = apache_getenv("HTTP_HOST") . apache_getenv("REQUEST_URI");
            ...
            # CURL SETTINGS.
            curl_setopt($curl, CURLOPT_URL, "http://productsearch.linksynergy.com/productsearch?token=4acca9e0828906b9c844db7474c1db8ce6c652a873a8c625550cb57000808f5c&keyword=%22".$keyword."%22&cat=%22%22&MaxResults=1000&pagenumber=1&sort=productname&sorttype=asc");
...
Scroll Up</a>
<h6>Copyright House of Sale 2014</h6></div>
