...
<body>
    ...
    <nav class="app-content" id="data-items" ng-app="" ng-controller="customersController">
        

        <ul class="list-unstyled main-menu" ng-repeat="x in names">
    ...
    <button type="submit" class="btn btn-default">
      ...
      <li ng-repeat="x in names"><a  href="brands.php?keyword=sale&mid={{x.mid}}&name={{x.advertiser_name}}">{{x.advertiser_name}}></a>
      ...
      Tops<span class="icon"></span>
        ...
        <li class="sub-nav">
      <a  href="brands.php?keyword=boots&mid={{x.mid}}&name={{x.advertiser_name}}">
      ...
      Skirts<span class="icon"></span>
        ...
        <li class="sub-nav">
      <a  href="brands.php?keyword=jackets&mid={{x.mid}}&name={{x.advertiser_name}}">
      Jackets<span class="icon"></span>
      </a>
      </li> 
      
      <li class="sub-nav">
      <a  href="brands.php?keyword=trousers&mid={{x.mid}}&name={{x.advertiser_name}}">
      Trousers<span class="icon"></span>
      </a>
      </li> 
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">      
        ...
        <a class="navbar-brand" href="./index.php">House of Sale</a>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1><?php echo $name ?></h1>
        <p><?php echo $row_brandssidebar['advertiser_description']; ?> </p>
      <?php
...
curl_setopt($curl, CURLOPT_RETURNTRANSFER, 1);
            ...
            {                    
                ...
                <h2> ".$name." {$item -> productname}</h2>
                   <a href =\"{$item -> linkurl}\"/> 
				   <img class=\"images, addthis_shareable\" src=\"{$item -> imageurl}\"addthis:url=\"".$request_url."\" addthis:title=\"" .$name."\"/></a>
				   
				   <h3>Description</h3>";
				   
				   echo strip_tags ("{$item -> description -> short}");
