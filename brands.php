...
<script src="//use.typekit.net/ipm4zuy.js"></script>
...
<body>
    ...
    <button type="submit" class="btn btn-default">
      ...
      <li class="sub-nav">
      <a  href="brands.php?keyword=trousers&mid=<?php echo $row_brandssidebar['mid']; ?>&name=<?php echo $row_brandssidebar['advertiser_name']; ?>">
